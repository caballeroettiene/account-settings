                                        ...
                                        <div className='content-right'>
                                            <div className="top-content">
                                                ...
                                                <div className="text-content">
                                                    <p>{t('content.warning.title')}</p>
                                                </div>
                                            </div>

                                            <div className="content-card">
                                                <p>{t('content.warning.sub_title.sub_1')}</p>
                                                <p>{t('content.warning.sub_title.sub_2')}</p>
                                                <p className="ticket">{t('content.warning.sub_title.sub_3')}: #{ticketId}</p>
                                            </div>

                                            {/* CARD */}
                                            <div className='card-thumb'>
                                                <img src="/warning-banner-v1.png" width="100%" alt='warning instagram accont' />
                                                <div className='thumb-content'>
                                                    <div className="warning-content">
                                                        <p className='review'>{t('content.thumb_review.sub_title.sub_1')}</p>
                                                        <h3>{t('content.thumb_review.title')}</h3>
                                                        <p>{t('content.thumb_review.sub_title.sub_2')}</p>
                                                    </div>
                                            ...
                                            <div className="warning-list">
                                                <p><b>{t('content.appeal_guide.title')}</b></p>
                                                <ul>
                                                    <li>{t('content.appeal_guide.sub_title.sub_1')}</li>
                                                    <li>{t('content.appeal_guide.sub_title.sub_2')}</li>
                                                    <li>{t('content.appeal_guide.sub_title.sub_3')}</li>
                                                </ul>
                                            </div>
                                            <br />
